...
5. Create the directory `workflows/<name>/` and write the workflow to `workflows/<name>/SKILL.md`. Place any supporting files (scripts, data, etc.) alongside `SKILL.md` in the same directory.
